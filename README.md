...
2) What steps can you take in your web apps to keep your data secure?
   you have to have a password and authentication, have control over the user input and permisions to access data
3) Describe how web servers work.
   web server is essentitally a tool that allows users to have access to the storage files based on requests.
